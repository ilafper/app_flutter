import 'package:app_flutter/crearClienteSql.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'apiService/apisql.dart';
import 'package:app_flutter/models/cliente.dart';
import '../components/header.dart';

class sql_Home extends StatefulWidget {
  const sql_Home({super.key});

  @override
  State<sql_Home> createState() => _Sql_HomeState();
}

class _Sql_HomeState extends State<sql_Home> {
  ...
  cargarclienteSql() async {
    clientes = await Apisql.clienteSql();
    cargando= false;
    mensajeErrror="";
    setState(() {});
  }
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
           ...
           await Navigator.push(
             context,
             MaterialPageRoute(builder: (context) => const CrearClienteSql()),
           );
           setState(() {
           cargarclienteSql();
           });
